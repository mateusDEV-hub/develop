...
const storageKey = "sportsTableDataAzul"; // Identificador único para a tabela azul
...
function addRow() {
    ...
    if (sport && score) {
        ...
        row.innerHTML = `<td>${sport}</td><td>${score}</td><td class="delete-btn ${authenticated ? '' : 'hidden'}"><button onclick="deleteRow(this)">Excluir</button></td>`;
        saveTable();
    } else {
